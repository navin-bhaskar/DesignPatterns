...
def place_numbers(params: DisplayParams):
    nums = params.nums
    label = ""
...
def display_markers(params: DisplayParams):
...
def display_buildings(params: DisplayParams):
...
def display_array(params: DisplayParams):
    arr = params.nums
    label = ""
...
def place_indices(params: DisplayParams):
    arr = params.nums
    temp = DisplayParams()
